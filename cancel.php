...
<head>
  ...
  <style>
    ...
    a { color:#8a3b24; font-weight:900; }
  </style>
</head>
<body>
  <div class="wrap">
    <div class="card">
      <h1>カード決済を中断しました。</h1>
      <p>決済は完了していません。注文も確定していません。</p>
      <p>もう一度ご注文いただくか、現金払い・お電話でのご予約をご利用ください。</p>
      <p><a href="./">注文ページに戻る</a></p>
      <p><a href="tel:0574461128">電話で予約する：0574-46-1128</a></p>
    </div>
  </div>
</body>
</html>
